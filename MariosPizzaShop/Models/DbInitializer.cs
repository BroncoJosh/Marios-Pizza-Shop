	...
	public static class DbInitializer
	{
		public static void Seed(AppDbContext context)
		{
		    ...
		    if (!context.Categories.Any())
		    {
                ...
                context.AddRange
		        (
		            new Category { CategoryName = "Meat Pizzas", Description = "MEATS"},
		            new Category { CategoryName = "Non-Meat Pizzas", Description = "!MEATS"},
		            new Category { CategoryName = "Specialty Pizzas", Description = "RANDOM PIZZA", }
                );
		    }
            ...
            if (!context.Pizzas.Any())
			{
				...
				(
					new Pizza
					{
						Name = "Pepperoni Pizza", Price = 12.95M, ShortDescription = "The Original", LongDescription = "Icing carrot cake jelly-o cheesecake. Sweet roll marzipan marshmallow toffee brownie brownie candy tootsie roll. Chocolate cake gingerbread tootsie roll oat cake pie chocolate bar cookie dragée brownie. Lollipop cotton candy cake bear claw oat cake. Dragée candy canes dessert tart. Marzipan dragée gummies lollipop jujubes chocolate bar candy canes. Icing gingerbread chupa chups cotton candy cookie sweet icing bonbon gummies. Gummies lollipop brownie biscuit danish chocolate cake. Danish powder cookie macaroon chocolate donut tart. Carrot cake dragée croissant lemon drops liquorice lemon drops cookie lollipop toffee. Carrot cake carrot cake liquorice sugar plum topping bonbon pie muffin jujubes. Jelly pastry wafer tart caramels bear claw. Tiramisu tart pie cake danish lemon drops. Brownie cupcake dragée gummies.", Category = Categories["Meat Pizzas"], ImageUrl = "https://imagesvc.timeincapp.com/v3/mm/image?url=http%3A%2F%2Fcdn-image.myrecipes.com%2Fsites%2Fdefault%2Ffiles%2Fstyles%2Fmedium_2x%2Fpublic%2Fimage%2Frecipes%2Fck%2Fgluten-free-cookbook%2Fpepperoni-pizza-ck-x.jpg%3Fitok%3DbQsFo3PZ&w=700&q=85", InStock = true, IsPizzaOfTheWeek = true, ImageThumbnailUrl = "https://imagesvc.timeincapp.com/v3/mm/image?url=http%3A%2F%2Fcdn-image.myrecipes.com%2Fsites%2Fdefault%2Ffiles%2Fstyles%2Fmedium_2x%2Fpublic%2Fimage%2Frecipes%2Fck%2Fgluten-free-cookbook%2Fpepperoni-pizza-ck-x.jpg%3Fitok%3DbQsFo3PZ&w=700&q=85", AllergyInformation = ""
					},
					new Pizza
					{
                        Name = "Three Meat Pizza", Price = 18.95M, ShortDescription = "Mo Meat Mo Problems", LongDescription = "Icing carrot cake jelly-o cheesecake. Sweet roll marzipan marshmallow toffee brownie brownie candy tootsie roll. Chocolate cake gingerbread tootsie roll oat cake pie chocolate bar cookie dragée brownie. Lollipop cotton candy cake bear claw oat cake. Dragée candy canes dessert tart. Marzipan dragée gummies lollipop jujubes chocolate bar candy canes. Icing gingerbread chupa chups cotton candy cookie sweet icing bonbon gummies. Gummies lollipop brownie biscuit danish chocolate cake. Danish powder cookie macaroon chocolate donut tart. Carrot cake dragée croissant lemon drops liquorice lemon drops cookie lollipop toffee. Carrot cake carrot cake liquorice sugar plum topping bonbon pie muffin jujubes. Jelly pastry wafer tart caramels bear claw. Tiramisu tart pie cake danish lemon drops. Brownie cupcake dragée gummies.", Category = Categories["Meat Pizzas"], ImageUrl = "http://static.wixstatic.com/media/bb97fc_2900f16ff52649a3a1a52988016ddd9e.jpg/v1/fill/w_420,h_315,al_c,lg_1,q_80/bb97fc_2900f16ff52649a3a1a52988016ddd9e.webp", InStock = true, IsPizzaOfTheWeek = false, ImageThumbnailUrl = "http://static.wixstatic.com/media/bb97fc_2900f16ff52649a3a1a52988016ddd9e.jpg/v1/fill/w_420,h_315,al_c,lg_1,q_80/bb97fc_2900f16ff52649a3a1a52988016ddd9e.webp", AllergyInformation = ""
					},
					new Pizza
					{
					    Name = "Cowboy Pizza", Price = 18.95M, ShortDescription = "Get your western on", LongDescription = "Icing carrot cake jelly-o cheesecake. Sweet roll marzipan marshmallow toffee brownie brownie candy tootsie roll. Chocolate cake gingerbread tootsie roll oat cake pie chocolate bar cookie dragée brownie. Lollipop cotton candy cake bear claw oat cake. Dragée candy canes dessert tart. Marzipan dragée gummies lollipop jujubes chocolate bar candy canes. Icing gingerbread chupa chups cotton candy cookie sweet icing bonbon gummies. Gummies lollipop brownie biscuit danish chocolate cake. Danish powder cookie macaroon chocolate donut tart. Carrot cake dragée croissant lemon drops liquorice lemon drops cookie lollipop toffee. Carrot cake carrot cake liquorice sugar plum topping bonbon pie muffin jujubes. Jelly pastry wafer tart caramels bear claw. Tiramisu tart pie cake danish lemon drops. Brownie cupcake dragée gummies.", Category = Categories["Meat Pizzas"], ImageUrl = "https://imagesvc.timeincapp.com/v3/mm/image?url=http%3A%2F%2Fcdn-image.myrecipes.com%2Fsites%2Fdefault%2Ffiles%2Fstyles%2Fmedium_2x%2Fpublic%2Fimage%2Frecipes%2Foh%2F12%2Fsalami-and-mushroom-pizza-oh-x.jpg%3Fitok%3DjMRSeHj8&w=700&q=85", InStock = true, IsPizzaOfTheWeek = false, ImageThumbnailUrl = "https://imagesvc.timeincapp.com/v3/mm/image?url=http%3A%2F%2Fcdn-image.myrecipes.com%2Fsites%2Fdefault%2Ffiles%2Fstyles%2Fmedium_2x%2Fpublic%2Fimage%2Frecipes%2Foh%2F12%2Fsalami-and-mushroom-pizza-oh-x.jpg%3Fitok%3DjMRSeHj8&w=700&q=85", AllergyInformation = ""
					},
					new Pizza
					{
					    Name = "Vegetarian Pizza", Price = 15.95M, ShortDescription = "Healthy Veggies", LongDescription = "Icing carrot cake jelly-o cheesecake. Sweet roll marzipan marshmallow toffee brownie brownie candy tootsie roll. Chocolate cake gingerbread tootsie roll oat cake pie chocolate bar cookie dragée brownie. Lollipop cotton candy cake bear claw oat cake. Dragée candy canes dessert tart. Marzipan dragée gummies lollipop jujubes chocolate bar candy canes. Icing gingerbread chupa chups cotton candy cookie sweet icing bonbon gummies. Gummies lollipop brownie biscuit danish chocolate cake. Danish powder cookie macaroon chocolate donut tart. Carrot cake dragée croissant lemon drops liquorice lemon drops cookie lollipop toffee. Carrot cake carrot cake liquorice sugar plum topping bonbon pie muffin jujubes. Jelly pastry wafer tart caramels bear claw. Tiramisu tart pie cake danish lemon drops. Brownie cupcake dragée gummies.", Category = Categories["Non-Meat Pizzas"], ImageUrl = "http://cdn-image.myrecipes.com/sites/default/files/styles/medium_2x/public/image/recipes/ck/veggie-pizza-ck-1011287-x.jpg?itok=BTWz3vyH", InStock = true, IsPizzaOfTheWeek = false, ImageThumbnailUrl = "http://cdn-image.myrecipes.com/sites/default/files/styles/medium_2x/public/image/recipes/ck/veggie-pizza-ck-1011287-x.jpg?itok=BTWz3vyH", AllergyInformation = ""
					},
					new Pizza
					{
		...
		public static Dictionary<string, Category> Categories
		{
			get
			{
				if (categories == null)
				{
					...
					{
						new Category { CategoryName = "Meat Pizzas" },
						new Category { CategoryName = "Non-Meat Pizzas" },
